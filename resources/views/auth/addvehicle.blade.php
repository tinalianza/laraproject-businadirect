...
<div style="padding: 20px; max-width: 1000px; margin: auto;">
    ...
    <form id="registration-form" method="POST" action="{{ route('addvehicle.submit') }}" enctype="multipart/form-data"> 
        @csrf
        ...
        <div class="registration-form">
            <div class="details">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="employee-id" name="employee_id" value="{{ old('employee_id', $vehicle_owner->id_no ?? 'N/A') }}" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contact-no" name="contact_no" value="{{ old('contact_no', $vehicle_owner->contact_no) }}" readonly>
                </div>
            </div>
            ...
            <div class="vehicle-details">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="plate-number" name="plate_no" placeholder="LLL DDDD / L DDD LL" required pattern="([A-Za-z]{3}[0-9]{4}|[A-Za-z]{1}[0-9]{3}[A-Za-z]{2})(\s)?([A-Za-z]{3}[0-9]{4}|[A-Za-z]{1}[0-9]{3}[A-Za-z]{2})?" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="or-number" name="or_no" placeholder="DDDD-DDDDDDDDDDDD" required pattern="\d{4}-\d{12}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cr-number" name="cr_no" placeholder="DDDDDDDDD" required pattern="\d{9}" >
